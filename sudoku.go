...
make() is function that creates a data structure


rune is GO way of storing a single character.....we use it here in sudoku as each cell stores a single character.
